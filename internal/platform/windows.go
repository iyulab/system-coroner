	...
	return []Check{
		{
			...
			Script:        "scripts/windows/c2_connections.ps1",
		...
		},
		{
			...
			Script:        "scripts/windows/account_compromise.ps1",
			Timeout:       30 * time.Second,
			OutputFormat:  "json",
			RequiresAdmin: true,
		},
		{
			...
			Script:        "scripts/windows/persistence.ps1",
			Timeout:       30 * time.Second,
			OutputFormat:  "json",
			RequiresAdmin: false,
		},
		{
			...
			Script:        "scripts/windows/lolbin_abuse.ps1",
			Timeout:       30 * time.Second,
			OutputFormat:  "json",
			RequiresAdmin: true,
		},
		{
			...
			Script:        "scripts/windows/fileless_attack.ps1",
			Timeout:       30 * time.Second,
			OutputFormat:  "json",
			RequiresAdmin: false,
		},
		{
			...
			Script:        "scripts/windows/log_tampering.ps1",
			Timeout:       30 * time.Second,
			OutputFormat:  "json",
			RequiresAdmin: true,
		},
		{
			...
			Script:        "scripts/windows/credential_dump.ps1",
			Timeout:       30 * time.Second,
			OutputFormat:  "json",
			RequiresAdmin: true,
		},
		{
			...
			Script:        "scripts/windows/lateral_movement.ps1",
			Timeout:       30 * time.Second,
			OutputFormat:  "json",
			RequiresAdmin: true,
		},
		{
			...
			Script:        "scripts/windows/webshell.ps1",
			Timeout:       30 * time.Second,
			OutputFormat:  "json",
			RequiresAdmin: false,
		},
